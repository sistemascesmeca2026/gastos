-- Migración: regresar v_saldo_partida a su versión simple original
-- (Ministrado, Comprometido, Ejercido, Por ejercer calculados),
-- revirtiendo la versión de 10 columnas.
