-- Agrega dependencia, fondo, fondo_nombre a v_saldo_partida (al final, por la
-- restricción de PostgreSQL de no insertar columnas en medio con CREATE OR REPLACE).
-- Permite filtrar el sistema por "espacio de trabajo" (Patty Ruiz vs Patty Ballinas).
