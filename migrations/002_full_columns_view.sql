-- Migración: exponer las 10 columnas oficiales del Estado Presupuestal
-- (Original, Modificado, Ministrado, Pre-compromiso, Comprometido, Devengado,
--  Ejercido, Pagado, Por ejercer, Disponible) en la vista v_saldo_partida.
--
-- Nota: Ministrado, Comprometido, Ejercido y Por ejercer se siguen calculando
-- dinámicamente cruzando la línea base con los movimientos capturados (igual
-- que antes). Original, Modificado, Pre-compromiso, Devengado, Pagado y
-- Disponible se toman tal cual del snapshot oficial más reciente (PDF),
-- ya que esos no cambian con la captura diaria de oficios.
